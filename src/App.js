...
function App() {
  ...
  return (
    <div className="bg-primary text-light">
      ...
      <section
        id="top"
        className="min-h-screen relative overflow-x-hidden w-screen"
      >
        <motion.div 
         animate={{x: 0}}
         initial={{x: '-50vw'}}
